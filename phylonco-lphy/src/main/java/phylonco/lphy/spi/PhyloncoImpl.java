...
import phylonco.lphy.io.WriteHaploidFasta;
...
public class PhyloncoImpl extends LPhyBaseImpl {
    ...
    public List<Class<? extends BasicFunction>> declareFunctions() {
        return Arrays.asList( GT16.class, PhasedGenotypeFunction.class, UnphaseGenotypeAlignment.class, WriteHaploidFasta.class);
    }
