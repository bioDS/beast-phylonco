...
public class BeagleTreeLikelihoodWithError extends TreeLikelihood {
    ...
    private boolean initialize() {
        ...
        partialBufferHelper = new BufferIndexHelper(m_nNodeCount, 0);
...
//                preferenceFlags |= BeagleFlag.SCALING_MANUAL.getMask();
        ...
        if (errorModel != null) {
            Log.warning.println("  Using error model in tip likelihoods");
        ...
        for (int i = 0; i < tipCount; i++) {
            ...
            if (m_bUseAmbiguities || m_bUseTipLikelihoods || useTipsEmpirical || errorModel != null) {
                setPartials(beagle, i, taxon, false);
            } else {
    ...
    protected final void setPartials(Beagle beagle,
                                     int nodeIndex, int taxon, boolean flip) {
        ...
        for (int i = 0; i < patternCount; i++) {
            ...
            if (errorModel != null) {
                ...
                tipProbabilities = errorModel.getProbabilities(stateIndex);
...
//            }
        ...
        if (!node.isLeaf()) {
            ...
            setPartials(beagle, nodeNum, taxon, false);
        }
     ...
     */
    protected boolean updateErrorModel;
